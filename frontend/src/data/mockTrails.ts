...
const mockTrails: Trail[] = [
  ...
  { id: 'bc-west', name: 'Brushy Creek - West', position: [30.5100, -97.8100] as LatLngExpression, status: 'update needed', lastUpdated: '2026-04-10T12:00:00Z' },
  ...
  { id: 'mt-lakeway', name: 'Lakeway', position: [30.3900, -97.9700] as LatLngExpression, status: 'update needed', lastUpdated: '2026-04-08T15:00:00Z' },
  ...
  { id: 'reveille-peak-ranch', name: 'Reveille Peak Ranch', position: [30.7200, -98.4000] as LatLngExpression, status: 'update needed', lastUpdated: '2026-04-09T12:00:00Z' },
  ...
  { id: 'thumper', name: 'Thumper', position: [30.4200, -97.7600] as LatLngExpression, status: 'update needed', lastUpdated: '2026-04-11T14:00:00Z' },
